...
Output: 3 
slow, fast pointer -> slow 1 step, fast 2 step -> jab fast null pe hoga to slow mid pe hoga -> jab tk fast null nhi hojata aur fast ka next pointer hai aur slow null nhi hojata -> update slow fast) -> return slow/slow ka data*/
